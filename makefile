...
all: simpleFeedback.c
	gcc -fvisibility=hidden -fPIC -Wl,-Bstatic -Wl,-Bdynamic -Wl,--as-needed -shared -pthread `pkg-config --cflags lv2` -lfftw3f -lm `pkg-config --libs lv2` simpleFeedback.c -o simpleFeedback.so -lfftw3f
